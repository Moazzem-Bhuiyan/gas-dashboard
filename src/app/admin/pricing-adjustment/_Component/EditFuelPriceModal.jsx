...
import { Form, Button, Modal, Divider, InputNumber } from 'antd';

const EditFuelPriceModal = ({ open, setOpen }) => {
  ...
  return (
    ...
    >
      ...
      <h1 className="text-2xl font-semibold text-center">Edit Price</h1>
      <Divider />
      <div>
        <Form
          form={form}
